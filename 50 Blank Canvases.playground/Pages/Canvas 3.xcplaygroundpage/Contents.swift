...
canvas.fillColor = Color.black
for x in stride(from: -60, through: 60, by: 120){
    canvas.drawEllipse(centreX: x, centreY: -110, width: 70, height: 70)
}
canvas.fillColor
...
canvas.drawEllipse(centreX: 70, centreY: 150, width: 60, height: 70)
canvas.drawEllipse(centreX: 0, centreY: 50, width: 60, height: 70)
